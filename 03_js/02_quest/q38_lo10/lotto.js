...
let lotto_number = repeat_1(6);
let win = 0;
let result;
// let bouns_number = repeat_1(1);

// for(let i=0; i<6; i++){
//     if(auto_number[i] == bouns_number){
//        bouns_number = repeat_1[0];
//     }
// }
...
/*
let bouns_match = false;
for(let i=0 ; i<6 ; i++){
    if(bouns_number == lotto_number[c])
        bouns_match = true;   
    }      
}
if (bouns_match == true){
...
// document.write(" 보너스: " +bouns_number);
document.write("<hr>");
