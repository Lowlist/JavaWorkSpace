...
function fightInfo(first,second) {
    ...
    dw("[" + second.name + "]의 공격! [" + first.name + "]에게 [" + first_damege + "]만큼의 데미지를 주었다!"); br();
    dw("[" + first.name + "]의 남은체력:[" + first.hp + "]");
    hr();
    dw("[" + first.name + "]의 공격! [" + second.name + "]에게 [" + second_damege + "]만큼의 데미지를 주었다!"); br();
