...
function c_janken() {
   ...
   if (np_player == 1) {
      np_player = "가위";
      document.getElementById("player_c").innerHTML ='<img src="c_sc.png">';
   }
   else if (np_player == 12) {
      np_player = "바위";
      document.getElementById("player_c").innerHTML ='<img src="c_ro.png">';
   }
   else if (np_player == 4) {
      np_player = "보";
      document.getElementById("player_c").innerHTML ='<img src="c_sc.png">';
...
// 이미지 함수 (굳이 안넣어도 되긴하는데 넣고싶을땐 어떻게 하나요)
/*
...
function j_img(){
   ...
   document.getElementById("player_c").innerHTML = '<img src="c_pa.png">';
   }
...
function bt_1() {
   ...
   j_log();
   l_d_result();
   document.getElementById("player").innerHTML = "<img src='c_sc.png'>";
...
function bt_2() {
   ...
   j_log();
   l_d_result();
   document.getElementById("player_a").innerHTML = "<img src='c_ro.png'>";
...
function bt_3() {
   ...
   j_log();
   l_d_result()
   document.getElementById("player").innerHTML = "<img src='c_ro.png'>";
}
